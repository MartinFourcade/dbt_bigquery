...
DATE_DIFF(o.ORDER_DELIVERED_CUSTOMER_DATE, o.ORDER_PURCHASE_TIMESTAMP, DAY) as delivery_time_days,
DATE_DIFF(o.ORDER_DELIVERED_CUSTOMER_DATE, o.ORDER_ESTIMATED_DELIVERY_DATE, DAY) delivery_time_estimation,
